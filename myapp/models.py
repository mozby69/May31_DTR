...
class Employee(models.Model): 
    ...
    DateofBirth = models.DateField(default=date(2000, 1, 1), null=True,blank=True)
    BloodType = models.CharField(max_length=3, default="N/D",null=True,blank=True) 
    Gender = models.CharField(max_length=8, default="Male",null=True,blank=True)
    CivilStatus = models.CharField(max_length=10, default="N/A",null=True,blank=True) 
    Address = models.CharField(max_length=50, default="N/D",null=True,blank=True)
    Position = models.CharField(max_length=50,null=True,blank=True) 
    Department = models.CharField(max_length=50, default="N/A", null=True, blank=True) 
    EmployementDate = models.DateField(default=date(2000, 1, 1), null=True,blank=True) 
    EmploymentStatus = models.CharField(max_length=15,default="Regular",null=True,blank=True) 
...
class DailyRecord(models.Model):
    ...
    flex_time = models.CharField(max_length=15, null=True,blank=True)
...
class temporay(models.Model):
    ...
    #six_serviamus_timein = models.CharField(max_length=100,null=True,blank=True)
    #seven_serviamus_timein = models.CharField(max_length=100,null=True,blank=True)
