...
# from django.conf.urls.static import static
from .app_views.NAZARETH import main_nazareth_page, fetch_messages_nazareth,display_qr_list_nazareth,webcam_qr_code_scanner_nazareth
...
from .app_views.Profiler import Profiler
from .app_views.ProfilerForm import ProfilerForm
from .app_views.FaceCapture import FaceCapture,camera_feed,capture_image
...
urlpatterns = [
    ...
    #face recog
    path('Profiler/', Profiler, name="Profiler"),
    path('ProfilerForm/', ProfilerForm, name="ProfilerForm"),
    path('FaceCapture/',FaceCapture, name="FaceCapture"),
