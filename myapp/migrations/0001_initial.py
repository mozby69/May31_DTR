# Generated by Django 4.2.7 on 2024-05-24 01:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('BloodType', models.CharField(blank=True, default='N/D', max_length=3, null=True)),
                ('Gender', models.CharField(blank=True, default='Male', max_length=8, null=True)),
                ('CivilStatus', models.CharField(blank=True, default='N/A', max_length=10, null=True)),
                ('Address', models.CharField(blank=True, default='N/D', max_length=50, null=True)),
                ('Position', models.CharField(blank=True, max_length=50, null=True)),
                ('Department', models.CharField(blank=True, default='N/A', max_length=50, null=True)),
                ('EmployementDate', models.DateField(blank=True, default=datetime.date(2000, 1, 1), null=True)),
                ('EmploymentStatus', models.CharField(blank=True, default='Regular', max_length=15, null=True)),
